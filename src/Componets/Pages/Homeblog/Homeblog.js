            ...
            <div className="col-md-4 mb-4 mb-md-0">
              <div className={`card`}>
                ...
                <div className="card-body py-3 px-2">
                  <NavLink to="#" className={homecss.navdecoration}>
                    <h5 className={`card-text p-0 mb-1 font-weight-bold ${homecss.howtitlesmallres}`}>How To Smartphone Have Revolutionized Online Gaming ?</h5>
                  </NavLink>
                  <p className={`card-text p-0 ${homecss.howtitlesmallupdated} `}><small class="text-muted">Last updated: December 18,2022</small></p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4 mb-md-0">
              <NavLink to="#" className={homecss.navdecoration}>
                <div className={`card `}>
                  ...
                  <div className="card-body py-3 px-2">
                    <h5 className={`card-text  p-0 mb-1font-weight-bold ${homecss.howtitlesmallres}`}>Decrypting Economic Calender for Use When Trading</h5>
                    <p className={`card-text p-0 ${homecss.howtitlesmallupdated} `}><small className="text-muted">Last updated: December 18,2022</small></p>
                  </div>
                </div>
              </NavLink>
            </div>
            <div className="col-md-4 mb-4 mb-md-0">
              <NavLink to="#" className={homecss.navdecoration}>
                <div className={`card`}>
                  ...
                  <div className="card-body py-3 px-2">
                    <h5 className={`card-text p-0 mb-1 font-weight-bold ${homecss.howtitlesmallres}`}>How To Smartphone Have Revolutionized Online Gaming ?</h5>
                    <p className={`card-text text-xs-lg p-0 ${homecss.howtitlesmallupdated} `}><small className="text-muted">Last updated: December 18,2022</small></p>
              ...
              <NavLink to="#" className={homecss.navdecoration}>
                <div className={`card mb-3  cardhowtoguide ${homecss.CardSmall}`}>
                  <div className="d-flex">
                    ...
                    <div className="card-body">
                      <p className={`card-text font-weight-bold p-0 ${homecss.howtitlesmallupdated}`}>The Complete Guide to Slot Machines</p>
                      <p className={`card-t p-0`}><small className="text-muted">November 12,2020</small></p>
                    </div>
                  </div>
                </div>
              </NavLink>
              ...
              <NavLink to="#" className={homecss.navdecoration}>
                <div className={`card mb-3  cardhowtoguide ${homecss.CardSmall}`}>
                  <div className="d-flex">
                    ...
                    <div className="card-body">
                      <p className={`card-text font-weight-bold p-0 ${homecss.howtitlesmallupdated}`}>How Successful Has the 5G Lunch Been in Ireland </p>
                      <p className={`card-text p-0`}><small className="text-muted">October 27,2020</small></p>
                    </div>
                  </div>
                </div>
              </NavLink>
              ...
              <NavLink to="#" className={homecss.navdecoration}>
                <div className={`card mb-3  cardhowtoguide ${homecss.CardSmall}`}>
                  <div className="d-flex">
                    ...
                    <div className="card-body ">
                      <p className={`card-text font-weight-bold p-0 ${homecss.howtitlesmallupdated}`}>Are Gaming Microtransaction Here to Stay?</p>
                      <p className={`card-te p-0`}><small className="text-muted">December 23,2020</small></p>
                    </div>
                  </div>
                </div>
              </NavLink>
