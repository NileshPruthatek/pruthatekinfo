                    ...
                    <div className="universalSubnav">
                        <div className="universalSubnav_scrollWrapper">
                            <div className="universalSubnav_items" section="category">
                                {catArray?.map((cat) => {
                                    return (
                                        <Link className={`p-2  ${techBlog.universalSubnavitems}`} style={{ cursor: "pointer" }} to={`${cat.isMain ? `/${cat.name}?x=${cat.uuid}` : `/${location.pathname.replace("/", "")}/${cat.name}?x=${cat.uuid}`}`} >
                                            {cat.name}
                                        </Link>
                                    );
                                })}
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechCard}`}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.cardContaine}`}>{record.containe}</p>

                                                    <p className="card-text">
                                                        <small class="text-muted">{record.update}</small>
                                                    </p>
                                                </div>
                                            </div>
                                        </NavLink>
                                                    ...
                                                    <div className="col-6   ">
                                                        <div className="card-body  p-0 pl-3">
                                                            ...
                                                            <p className={`card-text    ${techBlog.TechUpate}`}>
                                                                <small className="text-muted">Last updated: january 15,2021</small>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="col-4 ">
                                            ...
                                            <div className={`card  ${techBlog.FourateCard}`}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p className={`  ${techBlog.Updated}`}>
                                                        <small class="text-muted"> {fouratedata.update}</small>
                                                    </p>
                                                </div>
                                            </div>
                                        </NavLink>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsCards}`}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealscardContaine}`}>{techdealsdata.description}</p>
                                                    <p className="card-text">
                                                        <small className="text-muted">{techdealsdata.update}</small>
                                                    </p>
                                                </div>
                                            </div>
                                        </NavLink>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsRightCards}`}>
                                                <div className="card-body  p-0 pl-3">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealsRightContaine}`}>{techrightdata.description}</p>
                                                </div>
                                            </div>
                                        </NavLink>
                                    </div>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsCards}`}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealscardContaine}`}>{computingdata.description}</p>
                                                    <p className="card-text">
                                                        <small className="text-muted">{computingdata.update}</small>
                                                    </p>
                                                </div>
                                            </div>
                                        </NavLink>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsRightCards}`}>
                                                <div className="card-body  p-0 pl-3">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealsRightContaine}`}>{computingRightdata.description}</p>
                                                </div>
                                            </div>
                                        </NavLink>
                                    </div>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsCards}`}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealscardContaine}`}>{homegdata.description}</p>
                                                    <p className="card-text">
                                                        <small className="text-muted">{homegdata.update}</small>
                                                    </p>
                                                </div>
                                            </div>
                                        </NavLink>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsRightCards}`}>
                                                <div className="card-body  p-0 pl-3">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealsRightContaine}`}>{entertainmentRightdata.description}</p>
                                                </div>
                                            </div>
                                        </NavLink>
                                    </div>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsCards}`}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealscardContaine}`}>{servicesdata.description}</p>
                                                    <p className="card-text">
                                                        <small className="text-muted">{servicesdata.update}</small>
                                                    </p>
                                                </div>
                                            </div>
                                        </NavLink>
                                        ...
                                        <NavLink to="#" className={techBlog.navdecoration}>
                                            <div className={`card  ${techBlog.TechDealsRightCards}`}>
                                                <div className="card-body  p-0 pl-3">
                                                    ...
                                                    <p className={`card-contain  ${techBlog.TechDealsRightContaine}`}>{softwareRightdata.description}</p>
                                                </div>
                                            </div>
                                        </NavLink>
                                    </div>
