                            ...
                            return (
                                <div className={`card px-md-4 border-0`}>
                                    <NavLink to={`/blog?x=${blog?.uuid}`} className={`${techBlog.navdecoration} border`}>
                                        <img src={`${process.env.REACT_APP_IMG_BASEURL}/${blog["thumbnail_img"]}`} className={`h-50 w-100 ${techBlog.topImage}`} style={{ width: "100%" }} alt="..." />
                                        <div className="card-body p-3">
                                            <h5 className={`card-text font-weight-bold ${techBlog.howlargetitle}`} >{blog?.title}</h5>
                                        </div>
                                        <div className="card-info p-3">
                                            <p className="ml-3" style={{ fontSize: "15px" }}>{`Last Updated On : ${moment(blog?.["updated_at"]).format("DD MMM, YYYY")}`}</p>
                                        </div>
                                    </NavLink>
                                </div>
                            )
                                        ...
                                        <div className="row no-gutters h-100">
                                            <div className="col-7 pl-4 pr-2 py-2">
                                                <div className="card-body p-0">
                                                    ...
                                                    <p className={`card-text px-2 ${techBlog.howtitlesmallupdated} `} ><small className="text-muted">{`${moment(blog?.["updated_at"]).format("DD MMM, YYYY")}`}</small></p>
                                                </div>
                                            </div>
