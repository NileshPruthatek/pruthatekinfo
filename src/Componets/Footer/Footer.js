      ...
      <div className={footerstyle.footer}>
        <div className="container">
          <div className="row">
            ...
            <div
              className={`col-md-6 col-lg-3 mb-3  ${footerstyle.boderstyle}`}
            >
            ...
            >
              <ul>
                ...
                >
                  <form action="#" method="post">
                    <input
                      ...
                      maxlength="80"
                      required
                      className={footerstyle.Emailinput}
                    />
                    <button className={footerstyle.btn1}>
                      <i
                        className={` fa fa-paper-plane ${footerstyle.icon}`}
                      ></i>
                    </button>
                  </form>
                </li>
                ...
                >
                  ...
                  <img
                    src={facebook}
                    alert=" my aswome facebbok"
                    className={`m-2 ${footerstyle.socialicon}`}
                  />
                  <img
                    src={insta}
                    alert=" my aswome insta"
                    className={`m-2 ${footerstyle.socialicon}`}
                  />
                  <img
                    src={twitter}
                    alert="  my aswome twitter"
                    className={`m-2 ${footerstyle.socialicon}`}
                  />
                  <img
                    src={indeed}
                    alert="  my aswome indeed"
                    className={`m-2 ${footerstyle.socialicon}`}
                  />
                </li>
              </ul>
